...
export const LAYOUT_FAMILIES = [
  ...
  // 1,259-host geometry crawl, distinct from and additive to the 15 hand-authored above. ──────
  {
    name: "audio-transcript-workbench",
    pageKind: "landing",
    whenToUse: ["upload-and-transform-media", "show-a-working-input-to-output-flow", "product-with-technical-proof"],
    notFor: ["dense-admin-workflow", "long-form-reading", "pure-brand-statement"],
    dialCompatibility: { layoutVariance: [0.25, 0.7], contentDensity: [0.35, 0.8] },
    requiredContent: ["inputSurface", "liveOutputProof", "outputFormats"],
    antiPatterns: ["hero-only-with-no-working-surface", "equal-feature-card-row", "marketing-chrome-without-workflow"],
    mobileTransform: "stack-input-before-output-preserve-process-order",
    materialSlots: ["input-surface", "transcript-surface", "output-format-accent"],
    sectionGrammar: [
      { role: "nav", heightShare: 0.06, focalPoint: "left", composition: "logo-left-actions-right" },
      { role: "hero", heightShare: 0.28, focalPoint: "left", composition: "input-surface-plus-output-proof" },
      { role: "features", heightShare: 0.16, focalPoint: "center", composition: "output-format-rail" },
      { role: "proof", heightShare: 0.18, focalPoint: "left", composition: "ordered-process-steps" },
      { role: "pricing", heightShare: 0.14, focalPoint: "center", composition: "task-aligned-comparison" },
      { role: "cta", heightShare: 0.1, focalPoint: "center", composition: "committed-single-action" },
  ...
  {
    name: "research-index-grid",
    pageKind: "editorial",
    whenToUse: ["research-index", "article-catalogue", "latest-work-browse"],
    notFor: ["dense-admin-workflow", "single-screen-tool", "single-feature-article"],
    dialCompatibility: { layoutVariance: [0.3, 0.75], contentDensity: [0.3, 0.65] },
    requiredContent: ["featuredResearch", "articleCards", "browseContext"],
    antiPatterns: ["equal-card-grid-without-feature", "title-only-catalogue", "unbounded-card-density"],
    mobileTransform: "feature-first-stack-then-article-grid",
    materialSlots: ["masthead-rule", "featured-surface", "article-card-divider"],
    sectionGrammar: [
      { role: "nav", heightShare: 0.08, focalPoint: "left", composition: "masthead-and-sections" },
      { role: "hero", heightShare: 0.28, focalPoint: "left", composition: "featured-research-split" },
      { role: "features", heightShare: 0.42, focalPoint: "left", composition: "editorial-card-grid" },
      { role: "cta", heightShare: 0.08, focalPoint: "center", composition: "browse-more-action" },
      { role: "footer", heightShare: 0.14, focalPoint: "left", composition: "column-directory" },
    ],
  ...
  {
    name: "docs-three-rail-reader",
    pageKind: "docs",
    whenToUse: ["technical-book", "reference-with-anchors", "long-form-docs-navigation"],
    notFor: ["pure-brand-statement", "single-screen-tool", "dense-data-admin"],
    dialCompatibility: { layoutVariance: [0.1, 0.5], contentDensity: [0.25, 0.6] },
    requiredContent: ["navigationTree", "articleBody", "rightToc", "figureOrExample"],
    antiPatterns: ["full-width-prose-no-nav", "prose-wall-without-anchors", "three-rail-equal-importance"],
    mobileTransform: "collapse-left-rail-to-drawer-detach-right-toc-inline",
    materialSlots: ["sidebar-rail", "reading-surface", "figure-frame", "callout-accent"],
    sectionGrammar: [
      { role: "nav", heightShare: 0.06, focalPoint: "left", composition: "product-plus-search" },
      { role: "hero", heightShare: 0.12, focalPoint: "left", composition: "book-title-plus-context" },
      { role: "features", heightShare: 0.68, focalPoint: "left", composition: "left-tree-plus-measure-plus-right-toc" },
      { role: "cta", heightShare: 0.06, focalPoint: "left", composition: "prev-next-and-edit" },
      { role: "footer", heightShare: 0.08, focalPoint: "left", composition: "quiet-directory" },
    ],
