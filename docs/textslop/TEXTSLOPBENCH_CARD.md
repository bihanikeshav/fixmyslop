...
are declared for the next run: [`frozen-lamp-100.json`](../../textslopbench/manifests/frozen-lamp-100.json)
(5 genres) and [`frozen-beemo-100.json`](../../textslopbench/manifests/frozen-beemo-100.json) (5 use-cases).
