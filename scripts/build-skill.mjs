// scripts/build-skill.mjs — regenerate the staggered fixmyslop skill from the canonical
...
const dir = resolve(process.cwd(), "skills/fixmyslop");
...
console.log(`wrote skills/fixmyslop/ — SKILL.md (index) + design-law.md + ${VERBS.length} passes + reference/ (${REFERENCE.length} topics)`);
